...
// Mount the app directly here — Babel guarantees this runs after all
// components above are defined, avoiding the blank-page race condition.
const _rootEl = document.getElementById("root");
if (_rootEl) {
  ReactDOM.createRoot(_rootEl).render(<MainUI />);
}